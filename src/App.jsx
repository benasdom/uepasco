...
;
  ...
  return (
    <>
    <div className="page">
      <div className="rbackdrop2 z-up"></div>
<div className="promo" style={{position:"relative",fontWeight:600}}>
  <div className="rbackdrop2 z-up"></div>
  <span class="inv-ico">🎁</span> Promotion ends in: <p className="ticket">{`${ticket} ${counter}`}</p></div>
...
<div className="tel">
  <div className="telegram">
   ...
   {showpdf?
<Showfiles actualDlink={actualDlink} raw={raw} pdflink={pdflink} mainlogo={mainlogo} setshowpdf={setshowpdf} dataerror={dataerror} credits={credits} extract={extract}/>
:false}
