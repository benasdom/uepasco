...
<div className="rightmenu">
    <Search setsearching={setsearching} eprop={"none"} setfind={setfind} find={find} searching={searching} bar={bar}/>
                ...
                <div className="onne" title="profile"><div className="dp">ue-builds</div></div>
            </div>  
                      </ul>
...
:false}
       ...
       <div className="footer">
        ...
        <div className="twwo" title="make a suggestion">
                    <div className="search">{spin?<img src={spinner} className="spinner" width={200}/>:false}<i className="fa fa-envelope"></i></div>
