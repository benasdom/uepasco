    ...
    return (
        ...
        <div className="viewer">
            <div className="pdfloader">
                ...
                <a target='_blank' href={actualDlink} className="download">{<DownloadOutlined style={{marginRight:"5px"}}/>}Download</a><img className="logopdf" src={mainlogo} width="150" alt=""/></div>
