    ...
    return (
        ...
        <div className="viewer">
            <div className="pdfloader">
                ...
                <a target='_blank' href={actualDlink} className="download" style={{marginBottom:5}}>{<DownloadOutlined style={{marginRight:"5px"}}/>}Download <div className="prem3"></div></a><img className="logopdf" src={mainlogo} width="150" alt=""/></div>
